...
export default function PassMapComparison({
  ...
  useEffect(() => {
    async function fetchLeftPassMap() {
      ...
      if (selectedLeftSeason < 2019) {
        setErrorLeft('Pass map data only available from 2019 onwards');
        setIsLoadingLeft(false);
        return;
      }
  ...
  useEffect(() => {
    async function fetchRightPassMap() {
      ...
      if (selectedRightSeason < 2019) {
        setErrorRight('Pass map data only available from 2019 onwards');
        setIsLoadingRight(false);
        return;
      }
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="text-sm text-blue-900">
          ...
          <ul className="list-disc list-inside space-y-1 text-xs">
            <li>Pass map comparison is only available for QBs from 2019 onwards</li>
